...
d <- read_tsv(here("survey_data.txt"))
...
<!-- Your write-up around here. But don't write it in the comments like this, write it
     in the body of this document so that it's visible when knitted. --> 
...
<!-- Answer the question around here, but not in a comment. --> 
...
my.cor <- function(x,y){
  ...
  return(0) # change this to return the actual correlation
}
...
You can do this using the `sample` function, sampling the row numbers of
the data frame and then selecting those. Or you can use the `dplyr` function
`sample_n`.
...
for(i in 1:n.sim){
  ...
  # Your code, resampling the data frame and filling the column of
  # correlation statistics goes here. 
...
<!-- Place your work for the last two correlations around here. --> 
